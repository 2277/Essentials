...
public class Enchantments {
	...
	static {
		...
		// 1.13
		try {
			Enchantment channeling = Enchantment.getByKey(NamespacedKey.minecraft("channeling"));
			if (channeling != null) {
				ENCHANTMENTS.put("channeling", channeling);
			}
			Enchantment impaling = Enchantment.getByKey(NamespacedKey.minecraft("impaling"));
			if (impaling != null) {
				ENCHANTMENTS.put("impaling", impaling);
			}
			Enchantment loyalty = Enchantment.getByKey(NamespacedKey.minecraft("loyalty"));
			if (loyalty != null) {
				ENCHANTMENTS.put("loyalty", loyalty);
			}
			Enchantment riptide = Enchantment.getByKey(NamespacedKey.minecraft("riptide"));
			if (riptide != null) {

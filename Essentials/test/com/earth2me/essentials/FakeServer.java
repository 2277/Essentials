...
public class FakeServer implements Server {
	...
	public Player getPlayer(String string) {
		for (Player player : players) {
			if (player.getName().equalsIgnoreCase(string)) { return player; }
		}
		return null;
	}
	...
	public BukkitScheduler getScheduler() {
		return new BukkitScheduler() {
			...
			@Override
			public void runTask(Plugin arg0, Consumer<BukkitTask> arg1) throws IllegalArgumentException {
				throw new UnsupportedOperationException("Not supported yet.");
			}
			...
			@Override
			public void runTaskAsynchronously(Plugin arg0, Consumer<BukkitTask> arg1) throws IllegalArgumentException {
				throw new UnsupportedOperationException("Not supported yet.");
			}
			...
			@Override
			public void runTaskLater(Plugin arg0, Consumer<BukkitTask> arg1, long arg2)
					throws IllegalArgumentException {
			...
			@Override
			public void runTaskLaterAsynchronously(Plugin arg0, Consumer<BukkitTask> arg1, long arg2)
					throws IllegalArgumentException {
				throw new UnsupportedOperationException("Not supported yet.");
			}
			...
			@Override
			public void runTaskTimer(Plugin arg0, Consumer<BukkitTask> arg1, long arg2, long arg3)
					throws IllegalArgumentException {
				throw new UnsupportedOperationException("Not supported yet.");
			}
			...
			@Override
			public void runTaskTimerAsynchronously(Plugin arg0, Consumer<BukkitTask> arg1, long arg2, long arg3)
					throws IllegalArgumentException {
				throw new UnsupportedOperationException("Not supported yet.");
			}
	...
	public World getWorld(String string) {
		for (World world : worlds) {
			if (world.getName().equalsIgnoreCase(string)) { return world; }
		}
		return null;
	}
	...
	private org.bukkit.OfflinePlayer createOPlayer(final String string) {
		return new org.bukkit.OfflinePlayer() {
			...
			public UUID getUniqueId() {
				...
				} else if (string == "npc1") { return null; }
	...
	public org.bukkit.OfflinePlayer getOfflinePlayer(UUID arg0) {
		if (arg0.toString()
				.equalsIgnoreCase("3c9ebe1a-9098-43fd-bc0c-a369b76817ba")) { return createOPlayer("testPlayer1"); }
		if (arg0.toString().equalsIgnoreCase("f4a37409-5c40-3b2c-9cd6-57d3c5abdc76")) { return createOPlayer("npc1"); }
		throw new UnsupportedOperationException("Not supported yet.");
	}
